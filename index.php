		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:rgb(209, 197, 236);"></h4>
						<p style="color:#000">NEED HELP BOOKING A PACKAGE<br/>
                        For fantastic and customised suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9511915521&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 9823395078</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info@travelamigo.com&nbsp;&nbsp;&nbsp;</a></h5>
						<h5 style="color:#000"><span class="img3"></span>22,High Street,Pune.</h5>
                        <br/>
