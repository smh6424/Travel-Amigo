...
<tr><td colspan="2" class="toptd">Update Agent</td></tr>
<tr><td class="lefttxt">Select Agent</td><td><select name="t1" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Type of Agent</td><td><select name="s1" required /><option value="">Select</option>
